...
impl NativeSqlLlmStore {
    pub async fn ensure_default_keyword_index_for_tenant(
        ...
        let count: i64 = sqlx::query_scalar("SELECT COUNT(*) FROM llm_index WHERE tenant_id = ?")
            .bind(tenant_id)
            .fetch_one(self.pool())
            .await?;
        if count == 0 {
            self.insert_llm_index(
                tenant_id,
                "1",
                None,
                "keyword",
    ...
    pub async fn list_llm_indexes_for_tenant(
        &self,
        tenant_id: i64,
        page_size: i32,
    ...
    pub async fn retrieve_llm_index_for_tenant(
        &self,
        tenant_id: i64,
        index_uuid: &str,
    ...
    pub async fn update_llm_index_for_tenant(
        &self,
        tenant_id: i64,
        index_uuid: &str,
        status: Option<&str>,
        ...
        let existing = self
            .retrieve_llm_index_for_tenant(tenant_id, index_uuid)
            .await?
        ...
        self.retrieve_llm_index_for_tenant(tenant_id, index_uuid)
            .await
    }
    ...
    pub async fn ensure_default_retrieval_profile_for_tenant(
        ...
        let count: i64 =
            sqlx::query_scalar("SELECT COUNT(*) FROM llm_retrieval_profile WHERE tenant_id = ?")
                .bind(tenant_id)
                .fetch_one(self.pool())
                .await?;
        if count == 0 {
            self.insert_llm_retrieval_profile(
                tenant_id,
                "1",
                None,
                "keyword-default",
    ...
    pub async fn insert_llm_retrieval_profile(
        &self,
        tenant_id: i64,
        profile_uuid: &str,
        space_id: Option<i64>,
    ...
    pub async fn list_llm_retrieval_profiles_for_tenant(
        &self,
        tenant_id: i64,
        page_size: i32,
    ...
    pub async fn retrieve_llm_retrieval_profile_for_tenant(
        &self,
        tenant_id: i64,
        profile_uuid: &str,
    ...
    pub async fn update_llm_retrieval_profile_for_tenant(
        &self,
        tenant_id: i64,
        profile_uuid: &str,
        name: Option<&str>,
        ...
        let existing = self
            .retrieve_llm_retrieval_profile_for_tenant(tenant_id, profile_uuid)
            .await?
            .ok_or_else(|| NativeSqlStoreError::InvariantViolation {
        ...
        self.retrieve_llm_retrieval_profile_for_tenant(tenant_id, profile_uuid)
            .await
    }
    ...
    pub async fn ensure_default_implementation_profile_for_tenant(
        ...
        let count: i64 = sqlx::query_scalar(
            "SELECT COUNT(*) FROM llm_implementation_profile WHERE tenant_id = ?",
        )
        .bind(tenant_id)
        .fetch_one(self.pool())
        .await?;
        if count == 0 {
            self.insert_llm_implementation_profile(
                tenant_id,
                "1",
                "native-sql-phase1",
                "native_sql",
    ...
    pub async fn insert_llm_implementation_profile(
        &self,
        tenant_id: i64,
        profile_uuid: &str,
        name: &str,
    ...
    pub async fn list_llm_implementation_profiles_for_tenant(
        &self,
        tenant_id: i64,
        page_size: i32,
    ...
    pub async fn retrieve_llm_implementation_profile_for_tenant(
        &self,
        tenant_id: i64,
        profile_uuid: &str,
    ...
    pub async fn update_llm_implementation_profile_for_tenant(
        &self,
        tenant_id: i64,
        profile_uuid: &str,
        name: Option<&str>,
        ...
        let existing = self
            .retrieve_llm_implementation_profile_for_tenant(tenant_id, profile_uuid)
            .await?
            .ok_or_else(|| NativeSqlStoreError::InvariantViolation {
        ...
        self.retrieve_llm_implementation_profile_for_tenant(tenant_id, profile_uuid)
            .await
    }

    pub async fn insert_llm_provider_binding(
        &self,
        tenant_id: i64,
        binding_uuid: &str,
        provider_kind: &str,
    ...
    pub async fn list_llm_provider_bindings_for_tenant(
        &self,
        tenant_id: i64,
        page_size: i32,
    ...
    pub async fn retrieve_llm_provider_binding_for_tenant(
        &self,
        tenant_id: i64,
        binding_uuid: &str,
    ...
    pub async fn update_llm_provider_binding_for_tenant(
        &self,
        tenant_id: i64,
        binding_uuid: &str,
        ...
        let existing = self
            .retrieve_llm_provider_binding_for_tenant(tenant_id, binding_uuid)
            .await?
            .ok_or_else(|| NativeSqlStoreError::InvariantViolation {
        ...
        self.retrieve_llm_provider_binding_for_tenant(tenant_id, binding_uuid)
            .await
    }

    pub async fn insert_llm_eval_run(
        &self,
        tenant_id: i64,
        eval_run_uuid: &str,
        eval_type: &str,
    ...
    pub async fn list_llm_eval_runs_for_tenant(
        &self,
        tenant_id: i64,
        page_size: i32,
    ...
    pub async fn retrieve_llm_eval_run_for_tenant(
        &self,
        tenant_id: i64,
        eval_run_uuid: &str,
