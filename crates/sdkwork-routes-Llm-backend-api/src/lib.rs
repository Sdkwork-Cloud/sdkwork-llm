...
pub use sdkwork_llm_contract::{LlmBackendApi, LlmBackendRequestContext, ProblemDetails};
pub use web_bootstrap::{
    llm_backend_api_prefixes, llm_backend_api_public_path_prefixes,
...
pub fn gateway_mount(api: Arc<dyn LlmBackendApi>) -> Router {
