> Migrated from `docs/superpowers/plans/2026-06-10-Llm-open-api-and-no-embedding-mvp.md` on 2026-06-24.
> Owner: SDKWork maintainers

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build the first runnable SDKWork LLM backend that supports the generated Open API, App API, and Backend API contracts while proving memory retrieval works without embeddings.

**Architecture:** Keep `llm_record` and `llm_event` as canonical source-of-truth tables. Build a Rust service with explicit contract, product, storage, retrieval, and route boundaries; all search, vector, graph, file, or external-provider indexes remain pluggable derived capabilities behind ports. Open API clients use API key context, App/Backend API clients use dual-token context, and all three surfaces call the same product services.
...
- Open API authority: `sdks/sdkwork-llm-sdk/openapi/llm-open-api.openapi.json`
- App API authority: `sdks/sdkwork-llm-app-sdk/openapi/llm-app-api.openapi.json`
- Backend API authority: `sdks/sdkwork-llm-backend-sdk/openapi/llm-backend-api.openapi.json`
...
- Create: `Cargo.toml`
- Create: `crates/sdkwork-llm-contract/Cargo.toml`
- Create: `crates/sdkwork-llm-contract/src/lib.rs`
- Create: `crates/sdkwork-llm-contract/src/ids.rs`
- Create: `crates/sdkwork-llm-contract/src/dto.rs`
- Create: `crates/sdkwork-llm-contract/src/ports.rs`
- Create: `crates/sdkwork-llm-core/Cargo.toml`
- Create: `crates/sdkwork-llm-core/src/lib.rs`
- Create: `crates/sdkwork-llm-core/src/retrieval/mod.rs`
- Create: `crates/sdkwork-llm-core/src/retrieval/sql.rs`
- Create: `crates/sdkwork-llm-core/src/retrieval/keyword.rs`
- Create: `crates/sdkwork-llm-core/src/retrieval/dictionary.rs`
- Create: `crates/sdkwork-llm-core/src/retrieval/time.rs`
- Create: `crates/sdkwork-llm-core/src/retrieval/event.rs`
- Create: `crates/sdkwork-llm-core/src/retrieval/fusion.rs`
- Create: `crates/sdkwork-llm-core/src/context_pack.rs`
- Create: `crates/sdkwork-llm-core/src/learning.rs`
- Create: `crates/sdkwork-llm-test-support/Cargo.toml`
- Create: `crates/sdkwork-llm-test-support/src/lib.rs`
- Create: `services/sdkwork-llm-product/Cargo.toml`
- Create: `services/sdkwork-llm-product/src/lib.rs`
- Create: `services/sdkwork-llm-product/src/memory_service.rs`
- Create: `services/sdkwork-llm-product/src/retrieval_service.rs`
- Create: `services/sdkwork-llm-product/src/context_pack_service.rs`
- Create: `services/sdkwork-llm-product/src/learning_service.rs`
- Create: `services/sdkwork-llm-storage-sqlx/Cargo.toml`
- Create: `services/sdkwork-llm-storage-sqlx/src/lib.rs`
- Create: `services/sdkwork-llm-storage-sqlx/src/repositories.rs`
- Create: `services/sdkwork-llm-storage-sqlx/migrations/postgres/V202606100001__memory_core.sql`
- Create: `services/sdkwork-llm-storage-sqlx/migrations/sqlite/V202606100001__memory_core.sql`
- Create: `packages/native-rust/routes/open-api/sdkwork-routes-llm-open-api/Cargo.toml`
- Create: `packages/native-rust/routes/open-api/sdkwork-routes-llm-open-api/src/lib.rs`
- Create: `packages/native-rust/routes/open-api/sdkwork-routes-llm-open-api/src/paths.rs`
- Create: `packages/native-rust/routes/open-api/sdkwork-routes-llm-open-api/src/routes.rs`
- Create: `packages/native-rust/routes/open-api/sdkwork-routes-llm-open-api/src/manifest.rs`
- Create: `packages/native-rust/routes/open-api/sdkwork-routes-llm-open-api/src/handlers.rs`
- Create: `packages/native-rust/routes/app-api/sdkwork-routes-llm-app-api/Cargo.toml`
- Create: `packages/native-rust/routes/app-api/sdkwork-routes-llm-app-api/src/lib.rs`
- Create: `packages/native-rust/routes/app-api/sdkwork-routes-llm-app-api/src/paths.rs`
- Create: `packages/native-rust/routes/app-api/sdkwork-routes-llm-app-api/src/routes.rs`
- Create: `packages/native-rust/routes/app-api/sdkwork-routes-llm-app-api/src/manifest.rs`
- Create: `packages/native-rust/routes/app-api/sdkwork-routes-llm-app-api/src/handlers.rs`
- Create: `packages/native-rust/routes/backend-api/sdkwork-routes-llm-backend-api/Cargo.toml`
- Create: `packages/native-rust/routes/backend-api/sdkwork-routes-llm-backend-api/src/lib.rs`
- Create: `packages/native-rust/routes/backend-api/sdkwork-routes-llm-backend-api/src/paths.rs`
- Create: `packages/native-rust/routes/backend-api/sdkwork-routes-llm-backend-api/src/routes.rs`
- Create: `packages/native-rust/routes/backend-api/sdkwork-routes-llm-backend-api/src/manifest.rs`
- Create: `packages/native-rust/routes/backend-api/sdkwork-routes-llm-backend-api/src/handlers.rs`
- Create: `tests/contracts/openapi_phase1_contract_test.mjs`
- Create: `tests/contracts/schema_registry_phase1_contract_test.mjs`
- Create: `tests/no_embedding/llm_no_embedding_mvp_test.rs`
- Create: `tests/api/open_api_smoke_test.rs`
- Create: `tests/api/app_backend_api_smoke_test.rs`

## Invariants

- `llm_record` and `llm_event` are canonical; all indexes are derived and rebuildable.
...
resolver = "2"
members = [
  "crates/sdkwork-llm-contract",
  "crates/sdkwork-llm-core",
  "crates/sdkwork-llm-test-support",
  "services/sdkwork-llm-product",
  "services/sdkwork-llm-storage-sqlx",
  "packages/native-rust/routes/open-api/sdkwork-routes-llm-open-api",
  "packages/native-rust/routes/app-api/sdkwork-routes-llm-app-api",
  "packages/native-rust/routes/backend-api/sdkwork-routes-llm-backend-api",
]
...
Each crate starts with only dependencies it uses. Example `crates/sdkwork-llm-contract/Cargo.toml`:

```toml
[package]
name = "sdkwork-llm-contract"
...
- Create: `crates/sdkwork-llm-contract/src/dto.rs`
- Create: `crates/sdkwork-llm-contract/src/ports.rs`
- Test: `crates/sdkwork-llm-contract/tests/contract_surface.rs`

- [ ] **Step 1: Write failing tests for contract surface**

Create `crates/sdkwork-llm-contract/tests/contract_surface.rs`:

```rust
use sdkwork_llm_contract::{
    LlmEventRequest, MemoryImplementationCapabilities, LlmRecordRequest,
...
fn create_requests_are_serializable_contract_dtos() {
    let event = LlmEventRequest::new_text("evt-1", "User prefers concise answers");
    let record = LlmRecordRequest::new_fact("rec-1", "answer_style", "concise");
...
```powershell
cargo test -p sdkwork-llm-contract --test contract_surface
```
...
use crate::{LlmEventRequest, LlmRecordRequest, MemoryRetrieveRequest};

#[async_trait]
pub trait LlmEventStore: Send + Sync {
    async fn append(&self, request: LlmEventRequest) -> anyhow::Result<String>;
    async fn retrieve(&self, event_id: &str) -> anyhow::Result<Option<LlmEventRequest>>;
}

#[async_trait]
pub trait LlmRecordStore: Send + Sync {
    async fn create(&self, request: LlmRecordRequest) -> anyhow::Result<String>;
    async fn retrieve(&self, memory_id: &str) -> anyhow::Result<Option<LlmRecordRequest>>;
}
...
Add the remaining required Phase 1 tables in the same migration: `llm_record_source`, `llm_candidate`, `llm_habit`, `llm_retrieval_trace`, `llm_retrieval_hit`, and `llm_context_pack`.
...
- Create: `services/sdkwork-llm-storage-sqlx/src/lib.rs`
- Create: `services/sdkwork-llm-storage-sqlx/src/repositories.rs`
- Test: `services/sdkwork-llm-storage-sqlx/tests/repository_sqlite_test.rs`
...
```rust
use sdkwork_llm_contract::{LlmEventRequest, LlmEventStore, LlmRecordRequest, LlmRecordStore};
use sdkwork_llm_storage_sqlx::SqlxMemoryRepository;
...
async fn stores_events_and_records_without_embedding_tables() {
    ...
    let event_id = repo
        .append(LlmEventRequest::new_text("evt-1", "User prefers concise answers"))
        .await
        .unwrap();
    let record_id = repo
        .create(LlmRecordRequest::new_fact("rec-1", "answer_style", "concise"))
        .await
        .unwrap();
    ...
    assert!(LlmRecordStore::retrieve(&repo, "rec-1").await.unwrap().is_some());
}
```
...
```powershell
cargo test -p sdkwork-llm-storage-sqlx --test repository_sqlite_test
```
...
Implement `SqlxMemoryRepository` with `new_in_memory_sqlite()`, migration application, and the `LlmEventStore` / `LlmRecordStore` traits.
...
- Create: `crates/sdkwork-llm-core/src/retrieval/time.rs`
- Create: `crates/sdkwork-llm-core/src/retrieval/event.rs`
- Test: `crates/sdkwork-llm-core/tests/no_embedding_retrievers_test.rs`
...
```rust
use sdkwork_llm_contract::{MemoryRetrieveRequest, RetrieverKind};
use sdkwork_llm_core::retrieval::{DictionaryRetriever, KeywordRetriever, TimeRetriever};
...
```powershell
cargo test -p sdkwork-llm-core --test no_embedding_retrievers_test
```
...
- Create: `crates/sdkwork-llm-core/src/retrieval/fusion.rs`
- Create: `services/sdkwork-llm-product/src/retrieval_service.rs`
- Test: `services/sdkwork-llm-product/tests/retrieval_service_test.rs`
...
```rust
use sdkwork_llm_product::RetrievalService;
...
```powershell
cargo test -p sdkwork-llm-product --test retrieval_service_test
```
...
- Create: `crates/sdkwork-llm-core/src/context_pack.rs`
- Create: `services/sdkwork-llm-product/src/context_pack_service.rs`
- Test: `services/sdkwork-llm-product/tests/context_pack_service_test.rs`
...
```rust
use sdkwork_llm_product::ContextPackService;
...
fn context_pack_contains_traceable_selected_memories() {
    ...
    assert_eq!(pack.record_ids, vec!["rec-1", "rec-2"]);
...
```powershell
cargo test -p sdkwork-llm-product --test context_pack_service_test
```
...
- Create: `crates/sdkwork-llm-core/src/learning.rs`
- Create: `services/sdkwork-llm-product/src/learning_service.rs`
- Test: `services/sdkwork-llm-product/tests/learning_service_test.rs`
...
```rust
use sdkwork_llm_product::LearningService;
...
```powershell
cargo test -p sdkwork-llm-product --test learning_service_test
```
...
**Files:**
- Modify: `crates/sdkwork-llm-contract/src/ports.rs`
- Create: `crates/sdkwork-llm-contract/tests/provider_ports_test.rs`
...
```rust
use sdkwork_llm_contract::{EmbeddingModel, LanguageModel, RerankModel};
...
```powershell
cargo test -p sdkwork-llm-contract --test provider_ports_test
```
...
- Create: `packages/native-rust/routes/open-api/sdkwork-routes-llm-open-api/src/manifest.rs`
- Create: `packages/native-rust/routes/open-api/sdkwork-routes-llm-open-api/src/handlers.rs`
- Test: `packages/native-rust/routes/open-api/sdkwork-routes-llm-open-api/tests/route_manifest_test.rs`
...
```rust
use sdkwork_routes_llm_open_api::manifest::route_manifest;

#[test]
fn open_api_manifest_uses_mem_prefix_and_api_key_auth() {
    let manifest = route_manifest();
    assert_eq!(manifest.package_name, "sdkwork-routes-llm-open-api");
    assert_eq!(manifest.surface, "open-api");
    assert_eq!(manifest.api_authority, "sdkwork-llm-open-api");
    assert_eq!(manifest.sdk_family, "sdkwork-llm-sdk");
    assert_eq!(manifest.prefix, "/llm/v3/api");
    assert!(manifest.routes.iter().all(|route| route.path.starts_with("/llm/v3/api")));
...
```powershell
cargo test -p sdkwork-routes-llm-open-api --test route_manifest_test
```
...
pub const MEMORY_BASE: &str = "/llm/v3/api/llm";
...
```rust
assert_eq!(manifest.package_name, "sdkwork-routes-llm-app-api");
assert_eq!(manifest.surface, "app-api");
assert_eq!(manifest.api_authority, "sdkwork-llm.app");
assert_eq!(manifest.sdk_family, "sdkwork-llm-app-sdk");
...
```rust
assert_eq!(manifest.package_name, "sdkwork-routes-llm-backend-api");
assert_eq!(manifest.surface, "backend-api");
assert_eq!(manifest.api_authority, "sdkwork-llm.backend");
assert_eq!(manifest.sdk_family, "sdkwork-llm-backend-sdk");
...
```powershell
cargo test -p sdkwork-routes-llm-app-api --test route_manifest_test
cargo test -p sdkwork-routes-llm-backend-api --test route_manifest_test
```
...
async fn open_api_rejects_missing_api_key_and_does_not_use_dual_token_fallback() {
    let app = sdkwork_routes_llm_open_api::test_router();

    let response = app
        .oneshot(request_without_api_key("/llm/v3/api/llm/capabilities"))
        .await
        .unwrap();
...
const open = JSON.parse(fs.readFileSync("sdks/sdkwork-llm-sdk/openapi/llm-open-api.openapi.json", "utf8"));
...
for (const operation of operations) {
  ...
  assert.equal(operation["x-sdkwork-api-authority"], "sdkwork-llm-open-api");
}
```
...
```rust
use sdkwork_llm_product::MemoryProductRuntime;
...
```powershell
cargo test --test llm_no_embedding_mvp_test
```
...
- Modify: `docs/superpowers/plans/2026-06-10-llm-open-api-and-no-embedding-mvp.md`
